...
namespace DialogueSystem
{
    public class DialogueHandler : MonoBehaviour
    {
        ...
        public void StartDialogue(Dialogue[] dialogue, Sprite inPlayerSprite, Sprite inTalkerSprite,
            Action onDialogueFinished)
        {
            storedOnDialogueFinishedCb = onDialogueFinished;
            _dialogue = dialogue;
            InitializeDialogue(inPlayerSprite, inTalkerSprite);
            HandlePart();
        }
        ...
        IEnumerator TypeSentence(string sentence, string talkerName, bool isPlayer, bool isQuestion,
            bool finishesDialogue)
        {
        ...
        private void EnableButtons(bool isQuestion, bool finishesDialogue = false)
        {
        ...
        void HandlePart()
        {
            ...
            else
            {
                ...
                _inNoBranch = false;
                StopAllCoroutines();
                StartCoroutine(TypeSentence(part.sentence, part.talkerName, part.isPlayer, part.isQuestion,
                    part.finishesDialogue));
